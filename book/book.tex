...
Section~\ref{factdebug}.  Otra herramienta que quizás encuentres útil es el módulo {\tt pprint},
...
\item[hashable:] Un tipoi que tiene una función hash.  Los tipos inmutables
...
\end{verbatim}
%
En cada paso por el bucle, Python selects the next tuple in
