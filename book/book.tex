...
De lo contrario, {\tt n} se hace más pequeño cada vez que se recorre
...
Cada vez que se recorre el bucle, el programa muestra el valor de {\tt n}
...
{\tt n} será par cada vez que se recorra el bucle
...
\end{verbatim}
%
Para obtener la última letra de una cadena, podrías estar tentado a intentar algo
así:
...
Muchas computaciones implican procesar una cadena un carácter a la
...
\end{verbatim}
%
Cada vez que se recorre el bucle, el siguiente carácter en la cadena se asigna
...
contar}, y generalízalo para que acepte a la cadena y la
letra como argumentos.

Luego reescribe la función de modo que, en lugar de
recorrer la cadena, usa la versión de tres parámetros de {\tt
...
Como resultado, hay un método de cadena con nombre {\tt find} que
...
\end{verbatim}
%
Por defecto, {\tt find} parte del comienzo de la cadena, pero
puede tomar un segundo argumento, el índice donde debería partir:
...
\end{verbatim}
%
La primera vez que se recorre el bucle, el valor de {\tt j} es 4,
...
\item[contador:] Una variable usada para contar algo, usualmente inicializado
