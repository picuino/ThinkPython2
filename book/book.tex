...
posible.  Cuando hubo dos maneras de hacer algo, escogí
una y evité mencionar la otra.  O a veces puse la segunda
dentro de un ejercicio.

Ahora quiero volver por algunas de estas cosas buenas que dejé atrás.
...
Puedes casi leer esta línea como si estuviera en inglés: ``{\tt y} es log-{\tt x}
...
Las comprensiones de lista también pueden ser utilizadas para filtrar.  Por ejemplo,
...
bucles, a veces mucho más rápidas.  Así que si estás molesto conmigo por no
...
que lo hagas bien la primera vez.  Y para principianes eso significa nunca.
\index{depurar}
...
Las {\bf expresiones generadoras} con similares a las comprensiones de lista, pero
...
una secuencia de valores.  Pero a diferencia de una comprensión de lista, esta no
...
de valores booleanos y devuelve {\tt True} if alguno de los valores es {\tt
...
\end{verbatim}
%
En todos estos diccinarios, los valores son {\tt None} porque
nunca los utilizamos.  Como resultado, desperdiciamos algo de espacio de almacenamiento.
\index{diferencia de diccionarios}

Python proporciona otro tipo incorporado, llamado {\tt set} ({\em conjunto}), que
se comporta como una colección de claves de diccionario sin valores.  Añadir
elementos a un conjunto es rápido; por lo tanto lo es la verificación de pertenencia.  Y los conjuntos
...
Algunos de los ejercicios en este libro se pueden hacer de manera concisa y
...
Podemos también utilizar conjunto para hacer algunos de los ejercicios del
...
Podemos usar contadores para reescribir \verb"es_anagrama" del
...
crear valores nuevos.  Una función utilizada para crear oobjetos a veces es
...
como cadenas.  El valor de retorno de {\tt namedtuple} es un objeto de clase:
\index{namedtuple}
...
\verb"__str__", así qque no tienes que escribirlos.
...
Puedes acceder a los elementos de la tupla nombrada por sus nombres:
...
Sin embargo, puedes también tratar una tupla nombrada como una tupla:
...
Las tuplas nombradas proporcionan una manera rápida de definir clases simples.
El inconveniente es que las clases simples no siempre peranecen simples.
Tal vez decidas más tarde que quieres agregar métodos a una tupla nombrada.
...
\end{verbatim}
%
Si tienes un diccionario de palabras clave y valores, puedes usasr el
...
valores, dependieno de una condición.
\index{expresión condicional}
\index{condicional!expresión}
...
Reescribe el cuerpo de la función usando expresiones condicionales
anidadas.
