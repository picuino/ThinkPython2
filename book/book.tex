...
\index{corte!copia de}
\index{copia!de corte}
...
\index{búsqueda}
\index{búsqueda!patrón de} \index{sentencia!raise} \index{raise, sentencia}
...
permanente), por lo cual persiste después de que el programa termina.  \index{módulo!dbm}
\index{dbm, módulo}
