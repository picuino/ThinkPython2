...
cartas de juego, barajas de cartas y manos de póquer.
\index{baraja}
\index{carta de juego}
\index{póquer}

Si no juegas
póquer, puedes leer sobre este en
...
La herencia es la habilidad de definir una clase nueva que es una versión
...
manos que no tienen sentido para una baraja.  Por ejemplo, en el póquer
