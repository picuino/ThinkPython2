...
Escribe una función booleana llamada \verb"es_despues" que
...
{\tt aumentar}, el cual agrega un número dado de segundos al objeto {\tt Tiempo},
se puede escribir de manera natural como un
...
puras.  De hecho, algunos lenguages de programación solo permiten funciones
puras.  Existe evidencia de que los programas que usan funciones puras
son más rápidas de desarrollar y menos propensas a errores que los programas
que utilizan modificadores.  Sin embargo, los modificadores con convenientes en ocasiones,
...
Como ejercicio, escribe una versióin ``pura'' de {\tt aumentar} que
...
la ``columna de treinta y seis centenas''.
\index{sexagesimal}
...
ejercicio, reescribe {\tt aumentar} utilizando \verb"tiempo_a_int" y
\verb"int_a_tiempo".

En algunas formas, convertir de base 10 a base 10 y viceversa es más difícil
...
incremental o el desarrollo de proototipo.
...
proporcionan un rico conjunto de métodos y operadores.  Lee la
