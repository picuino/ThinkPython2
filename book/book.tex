...
operaciones, que un algoritmo requiere según un modelo de máquina dada.
...
escenario del {\bf peor de los casos}.  A veces es útil
...
de cadena como {\tt find} y {\tt count} también la usan.
...
Si la secuencia tiene 1.000.000 ítems, tomará cerca de 20 pasos
...
Hay otraa estructura de datos, llamada {\bf tabla hash} (en inglés, {\em hashtable}) que
...
gradualmente mejorarlo hasta que sea una tabla hash.
...
diccionario!  Para el resto de este capítulo, tienes que imaginas que
...
{\tt add} y {\tt get}
para averiguar cuál mapa poner en el
nuevo ítem, o cuál mapa buscar.
...
mutablese como las listas y diccionarios no son hashables.
\index{función hash}
...
hash diferentes se ajustarán al mismo índices.  Pero si la función hash
...
Aquí (finalmente) esá la idea clave que hace rápidas a las tablas hash: si
puedes mantener acotada la longitud máxima de los LinearMaps, {\tt
  LinearMap.get} es de tiempo constante.  Todo lo que tienes que haces es hacer un seguimiento
...
\item[búsqueda:] El problema de encontrar localizar un elemento de una colección
