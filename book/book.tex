...
no tienen que seguir de esa manera:
...
donde el nuevo valor de la nueva variable depende del antiguo.
...
Para algunos otros bucles, no es tan fácil decirlo.  Por ejemplo:
...
Cada vez que se recorre el bucle, el programa tiene como salida el valor de {\tt n}
...
A veces no sabes que es tiempo de terminar un bucle hasta que llegas a la mitad
del cuerpo.  En ese caso puedes usar la sentencia {\tt break}
para saltar hacia afuera fuera del bucle.
...
del bucle.  De lo contrario el programa echoes lo que escriba el usuario
