...
y devuelve un {\bf objeto de archivo} que puedes utilizar para leer el archivo.
\index{función open}
\index{open!función}
\index{texto plano}
\index{plano!texto}
...
\end{verbatim}
%
La primera palabra en esta particular lista es ``aa'', que es un tipo de
lava.  La secuencia \verb"\n" representa el carácter nueva línea que
separa esta palabra de la siguiente.

El objeto de archivo hace un seguimiento del lugar en el archivo en donde se encuentra, así que
...
Este capítulo presenta otro un tipo incorporado, la tupla, y luego
...
iniciarse desde Python utilizando un {\bf objeto de tubería} (en inglés, {\em pipe}), que
...
un caracter ``return'', representado por \verb"\r".  Algunos utilizan ambos.
...
de una clase tome objetos de la segunda clase como parámetros, o
...
con una función recursiva o método recursivo, todavía puedes utilizar las térnicas
