...
comando proporciona una manera eficiente de verificar que dos filas
...
El úlico problema con este ejemplo es que cuando importas
...
el programa inicia.  Si el programa se está ejecutando como un script,
...
{\tt reload}, pero puede ser complicado, por lo cual lo más seguro es
...
\item[archivo de texto:] Una secuencia de caracteres guardado en almacenamiento
permanente como un disco duro.
...
\item[capturar]: Evitar que una exceptión termine
...
\item Para doble verificación, puedes utilizar el comando Unix {\tt diff}.
\index{diff}
