...
dos números y redondea a un entero.  Por ejemplo, supongamos que la
...
Una alternativa es usar el {\bf operador módulo}, \verb"%", el cual
...
\end{verbatim}
%
El operador módulo es más útil de lo que parece.  Por
