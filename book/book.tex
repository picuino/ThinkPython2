...
esta función y usa la siguiente función como valor de retorno.''
...
A medida que escribes funciones más grandes, podrías encontrarte
pasando más tiempo depurando.

Para lidiar con programas cada vez más complejos,
podrías querer intentar un proceso llamado
...
\end{verbatim}
%
Si la función funciona, debería mostrar \verb"dx es 3" y
...
solo hay que verificar unas pocas líneas.
...
\end{verbatim}
%
Si eso funciona de manera correcta, estás listo.  De lo contrario, podrías
querer imprimir el valor de {\tt resultado} antes de la sentencia
return.
...
son útiles para depurar, pero una vez que haces funcionar la función, deberías
...
\item Una vez que el programa funciona, podrías querer borrar algo del
andamiaje o consolidar varias sentencias en una expresión
compuesta, pero solo si no hace que el programa sea difícil de
leer.
...
el centro del círculo y un punto del perímetro, y calcule
el área del círculo.
...
Hemos cubierto solo un pequeño subconjunto de Python, pero podrías
estar interesado en saber que este subconjunto es un lenguaje de programación {\em completo},
...
está siendo definido.  Una definición verdaderamente circular no es muy
útil:
...
\end{verbatim}
%
De lo contrario, y esta es la parte interesanto, tenemos que hacer una
