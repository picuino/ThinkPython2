...
% TODO: decidir cómo definir "the caller". Hasta el momento: "la llamadora"
...
retorno?  Una interfaz es ``limpia'' si permite al que llama hacer
...
En cambio, llamemos a la función más general {\tt polilinea}:
...
Una interfaz es como un contrato entre una función y una llamadora.
